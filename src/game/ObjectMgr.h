...
class ObjectMgr
{
    ...
    public:
        ...
        Guild* GetGuildByLeader(uint64 const&guid);
        Guild* GetGuildById(uint32 GuildId);
        Guild* GetGuildByName(const std::string& guildname);
        std::string GetGuildNameById(uint32 GuildId);
	...
	Guild* LoadGuildById(uint32 guildid);
	Guild* LoadGuildByName(const std::string& guildname);
	Guild* LoadGuildByLeader(const uint64 &guid);
