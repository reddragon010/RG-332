...
void WorldSession::HandleCharCreateOpcode(WorldPacket & recv_data)
{
    ...
    if (GetSecurity() <= SEC_MODERATOR && objmgr.IsReservedName(name))
    {
    ...
    if (GetSecurity() <=SEC_MODERATOR && class_ == CLASS_DEATH_KNIGHT && req_level_for_heroic > sWorld.getConfig(CONFIG_MAX_PLAYER_LEVEL))
    {
