...
#define GOSSIP_TEXT_VENDORS				"Vendors"
#define GOSSIP_TEXT_CAPITALPORTALS		"Capital Portals"
#define GOSSIP_TEXT_POI					"Points of Interest"
...
#define GOSSIP_TEXT_EASTERN				"Eastern Sewer Entrance"
#define GOSSIP_TEXT_WESTERN				"Western Sewer Entrance"
#define GOSSIP_TEXT_WELL				"Well Entrance"

#define GOSSIP_TEXT_HORDE				"The Horde Quarter"
#define GOSSIP_TEXT_ALLIANCE			"The Alliance Quarter"

#define GOSSIP_TEXT_NORTHERN			"Northern Bank"
#define GOSSIP_TEXT_SOUTHERN			"Southern Bank"

#define GOSSIP_TEXT_HORDEINN			"Horde Inn"
#define GOSSIP_TEXT_ALLIANCEINN			"Alliance Inn"
#define GOSSIP_TEXT_DALARANINN			"Dalaran Inn"

#define GOSSIP_TEXT_INNMAIL				"Inn"
#define GOSSIP_TEXT_BANKMAIL			"Bank"
#define GOSSIP_TEXT_KARASUSMAIL			"Krasus' Landing"

#define GOSSIP_TEXT_ARMOR				"Armor"
#define GOSSIP_TEXT_FLOWERS				"Flowers"
#define GOSSIP_TEXT_FRUIT				"Fruit"
#define GOSSIP_TEXT_GENERAL				"General Goods"
#define GOSSIP_TEXT_JEWERLY				"Jewelry"
#define GOSSIP_TEXT_PET					"Pet Supplies & Exotic Mounts"
#define GOSSIP_TEXT_PIE					"Pie, Pastry & Cakes"
#define GOSSIP_TEXT_REAGENZ				"Reagents & Magical Goods"
#define GOSSIP_TEXT_TOYS				"Toys"
#define GOSSIP_TEXT_TRINKETS			"Trinkets, Relics & Off-hand Items"
#define GOSSIP_TEXT_WEAPONS				"Weapons"
#define GOSSIP_TEXT_WHINE				"Wine & Cheese"

#define GOSSIP_TEXT_CLOTH				"Cloth Armor"
#define	GOSSIP_TEXT_LEATHER				"Leather Armor"
#define GOSSIP_TEXT_MAIL				"Mail Armor"
#define	GOSSIP_TEXT_PLATE				"Plate Armor"
#define GOSSIP_TEXT_SHIELDS				"Shields"
#define GOSSIP_TEXT_MELEE				"Melee Weapons"
#define GOSSIP_TEXT_RANGED				"Ranged & Thrown Weapons"
#define GOSSIP_TEXT_STAVES				"Staves & Wands"

#define GOSSIP_TEXT_VCITADEL			"The Violet Citadel"
#define GOSSIP_TEXT_VHOLD				"The Violet Hold"
#define GOSSIP_TEXT_DISTRICT			"Trade District"
#define GOSSIP_TEXT_KARASUS				"Krasus' Landing"
#define GOSSIP_TEXT_MEMORIAL			"Antonidas Memorial"
#define GOSSIP_TEXT_SQUARE				"Runeweaver Square"
#define GOSSIP_TEXT_EVENTIDE			"The Eventide"
#define GOSSIP_TEXT_CEMETERY			"Cemetery"
#define GOSSIP_TEXT_LEXICON				"Lexicon of Power"


#define GOSSIP_TEXT_COLDFLY				"Cold Weather Flying Trainer"
#define GOSSIP_TEXT_PORTAL				"Portal Trainer"
...
// Gossip defines
	...
	GOSSIP_SENDER_SEC_ARENA				= 11,
	GOSSIP_SENDER_SEC_AUCTIONHOUSE		= 12,
	GOSSIP_SENDER_SEC_VENDORS			= 13,
	GOSSIP_SENDER_THI_VENDORS			= 14,
	GOSSIP_SENDER_SEC_POI				= 15,
	GOSSIP_SENDER_SEC_TRAINERS			= 16,
	GOSSIP_SENDER_THI_TRAINERS			= 17
};
