...
void GossipMenu::AddMenuItem(uint8 Icon, const std::string& Message, uint32 dtSender, uint32 dtAction, const std::string& BoxMessage, uint32 BoxMoney, bool Coded, int32 locale_idx)
{
...
void GossipMenu::AddMenuItem(uint8 Icon, int32 trinityEntry, uint32 dtSender, uint32 dtAction, const std::string& BoxMessage, uint32 BoxMoney, bool Coded, int32 locale_idx)
{
    return AddMenuItem(Icon, objmgr.GetTrinityString(trinityEntry, locale_idx), dtSender, dtAction, BoxMessage, BoxMoney, Coded);
}

void GossipMenu::AddMenuItem(uint8 Icon, int32 trinityEntry, uint32 dtSender, uint32 dtAction, char const* BoxMessage, uint32 BoxMoney, bool Coded, int32 locale_idx)
{
    return AddMenuItem(Icon, objmgr.GetTrinityString(trinityEntry, locale_idx), dtSender, dtAction, BoxMessage, BoxMoney, Coded);
}

void GossipMenu::AddMenuItem(uint8 Icon, int32 trinityEntry, uint32 dtSender, uint32 dtAction, int32 trinityEntryMessage, uint32 BoxMoney, bool Coded, int32 locale_idx)
{
    return AddMenuItem(Icon, objmgr.GetTrinityString(trinityEntry, locale_idx), dtSender, dtAction, objmgr.GetTrinityString(trinityEntryMessage, locale_idx), BoxMoney, Coded);
}
...
void GossipMenu::AddMenuItem(uint8 Icon, const std::string& Message, bool Coded, int32 locale_idx)
{
    AddMenuItem(Icon, Message, 0, 0, "", 0, Coded);
}

void GossipMenu::AddMenuItem(uint8 Icon, char const* Message, bool Coded, int32 locale_idx)
{
    AddMenuItem(Icon, std::string(Message ? Message : ""),Coded);
}

void GossipMenu::AddMenuItem(uint8 Icon, char const* Message, uint32 dtSender, uint32 dtAction, char const* BoxMessage, uint32 BoxMoney, bool Coded, int32 locale_idx)
{
