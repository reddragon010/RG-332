...
class GossipMenu
{
    public:
        ...
        void AddMenuItem(uint8 Icon, const std::string& Message, bool Coded = false, int32 locale_idx = 3);
        void AddMenuItem(uint8 Icon, const std::string& Message, uint32 dtSender, uint32 dtAction, const std::string& BoxMessage, uint32 BoxMoney, bool Coded = false, int32 locale_idx = 3);
        void AddMenuItem(uint8 Icon, int32 trinityEntry, uint32 dtSender, uint32 dtAction, const std::string& BoxMessage, uint32 BoxMoney, bool Coded = false, int32 locale_idx = 3);
        void AddMenuItem(uint8 Icon, int32 trinityEntry, uint32 dtSender, uint32 dtAction, int32 trinityEntryMessage, uint32 BoxMoney, bool Coded = false, int32 locale_idx = 3);

        // for using from scripts, don't must be inlined
        void AddMenuItem(uint8 Icon, char const* Message, bool Coded = false, int32 locale_idx = 3);
        void AddMenuItem(uint8 Icon, char const* Message, uint32 dtSender, uint32 dtAction, char const* BoxMessage, uint32 BoxMoney, bool Coded = false, int32 locale_idx = 3);
        void AddMenuItem(uint8 Icon, int32 trinityEntry, uint32 dtSender, uint32 dtAction, char const* BoxMessage, uint32 BoxMoney, bool Coded = false, int32 local_idx = 3);
