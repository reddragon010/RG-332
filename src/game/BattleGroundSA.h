...
enum BG_SA_NPCs
  {
    ...
    BG_SA_NPC_RIGSPARK,
    BG_SA_NPC_TELEPORT_TRIGGER_1,
    BG_SA_NPC_TELEPORT_TRIGGER_2,
    BG_SA_NPC_TELEPORT_TRIGGER_3,
    BG_SA_NPC_TELEPORT_TRIGGER_4,
    BG_SA_NPC_TELEPORT_TRIGGER_5,
    BG_SA_MAXNPC
  };
...
const float BG_SA_NpcSpawnlocs[BG_SA_MAXNPC][4] =
  {
    ...
    // Teleport Trigger
    { 1454.889038,-248.568222,30.894232,3.756294 },// BLAU
    { 1370.609985,132.404266,30.891754,4.635944 }, // GRÜN
    { 1223.147095,-221.341904,55.411430,4.546684 }, // ROT
    { 1207.511841,85.177475,53.250412,5.654870 }, // ROSA
    { 1041.479126,-103.770828,84.636147,2.581163 }, // GELB
...
enum BG_SA_Objects
  {
    ...
    BG_SA_LEFT_FLAGPOLE,
    BG_SA_TELEPORTER_1, //BLAU
    BG_SA_TELEPORTER_2, //GRÜN
    BG_SA_TELEPORTER_3, //ROT
    BG_SA_TELEPORTER_4, //ROSA
    BG_SA_TELEPORTER_5, //GELB
    BG_SA_CENTRAL_FLAG,
    BG_SA_RIGHT_FLAG,
    BG_SA_LEFT_FLAG,
    BG_SA_MAXOBJ
...
const float BG_SA_ObjSpawnlocs[BG_SA_MAXOBJ][4] =
  {
    ...
    //Teleporter
    { 1468.835327 ,-225.355209,31.117050,4.001612 }, //BLAU
    { 1394.852661,72.320572,31.052055,2.340496 }, //GRÜN
    { 1255.631958,-233.810760,56.435665,4.111559 }, //ROT
    { 1216.735718,47.378414,54.276943,2.611793 }, //ROSA
    { 1065.171387,-89.842102,81.015096,4.409570 }, //GELB
    //Flags
