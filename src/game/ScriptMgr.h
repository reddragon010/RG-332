...
struct Script
{
    Script() :
        ...
        GetAI(NULL), GetInstanceData(NULL), pItemBuy(NULL)
    {}
    ...
    int8 (*pItemBuy)(Player*, Creature*, uint32, uint32, size_t*);
...
class ScriptMgr
{
	...
	int8 ItemBuy(Player* pPlayer, Creature* pCreature, uint32 itemId, uint32 count, size_t* vendorslot);
};
