...
bool GossipHello_guard_dalaran(Player* pPlayer, Creature* pCreature)
{
    ...
    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_CAPITALPORTALS       , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
    ...
    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_MAILBOX				, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_STABLEMASTER			, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
	pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_VENDORS				, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 12);
	pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_POI					, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 13);
...
void SendDefaultMenu_guard_dalaran(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    switch (uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF + 1:                    //Arena
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_EASTERN      , GOSSIP_SENDER_SEC_ARENA, GOSSIP_ACTION_INFO_DEF + 1);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_WESTERN      , GOSSIP_SENDER_SEC_ARENA, GOSSIP_ACTION_INFO_DEF + 2);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_WELL         , GOSSIP_SENDER_SEC_ARENA, GOSSIP_ACTION_INFO_DEF + 3);
			pPlayer->SEND_GOSSIP_MENU(13976, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 2:                    //Auction House
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HORDE		, GOSSIP_SENDER_SEC_AUCTIONHOUSE, GOSSIP_ACTION_INFO_DEF + 1);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALLIANCE     , GOSSIP_SENDER_SEC_AUCTIONHOUSE, GOSSIP_ACTION_INFO_DEF + 2);
            pPlayer->SEND_GOSSIP_MENU(14010, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 3:                    //Bank
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_NORTHERN		, GOSSIP_SENDER_SEC_BANK, GOSSIP_ACTION_INFO_DEF + 1);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_SOUTHERN     , GOSSIP_SENDER_SEC_BANK, GOSSIP_ACTION_INFO_DEF + 2);
            pPlayer->SEND_GOSSIP_MENU(14007, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 4:                    //Barber
            pPlayer->SEND_POI(5889, 622.227, 7, 99, 0, "Dalaran Barber");
            pPlayer->SEND_GOSSIP_MENU(14003, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 5:                    //Battelmasters
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HORDE		, GOSSIP_SENDER_SEC_AUCTIONHOUSE, GOSSIP_ACTION_INFO_DEF + 1);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALLIANCE     , GOSSIP_SENDER_SEC_AUCTIONHOUSE, GOSSIP_ACTION_INFO_DEF + 2);
            pPlayer->SEND_GOSSIP_MENU(13977, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 6:                    //Capital Portals
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HORDE		, GOSSIP_SENDER_SEC_AUCTIONHOUSE, GOSSIP_ACTION_INFO_DEF + 1);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALLIANCE     , GOSSIP_SENDER_SEC_AUCTIONHOUSE, GOSSIP_ACTION_INFO_DEF + 2);
            pPlayer->SEND_GOSSIP_MENU(13977, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 7:                    //Flight Master
            pPlayer->SEND_POI(5813, 449.107, 7, 99, 0, "Dalaran Flight Master");
            pPlayer->SEND_GOSSIP_MENU(14004, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 8:                    //Guild Master
            pPlayer->SEND_POI(5756, 620.785, 7, 99, 0, "Dalaran Visitor Center");
            pPlayer->SEND_GOSSIP_MENU(14015, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 9:                    //Inn
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HORDEINN		, GOSSIP_SENDER_SEC_INN, GOSSIP_ACTION_INFO_DEF + 1);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALLIANCEINN  , GOSSIP_SENDER_SEC_INN, GOSSIP_ACTION_INFO_DEF + 2);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_DALARANINN   , GOSSIP_SENDER_SEC_INN, GOSSIP_ACTION_INFO_DEF + 3);
			pPlayer->SEND_GOSSIP_MENU(14002, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 10:                   //Mailbox
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_INNMAIL      , GOSSIP_SENDER_SEC_MAILBOX, GOSSIP_ACTION_INFO_DEF + 1);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_BANKMAIL		, GOSSIP_SENDER_SEC_MAILBOX, GOSSIP_ACTION_INFO_DEF + 2);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_KARASUSMAIL  , GOSSIP_SENDER_SEC_MAILBOX, GOSSIP_ACTION_INFO_DEF + 3);
            pPlayer->SEND_GOSSIP_MENU(14008, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 11:                   //Stable Master
            pPlayer->SEND_POI(5859, 557.745, 7, 99, 0, "Dalaran Stable Master");
            pPlayer->SEND_GOSSIP_MENU(14001, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 12:                   //Vendors
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ARMOR        , GOSSIP_SENDER_SEC_VENDORS, GOSSIP_ACTION_INFO_DEF + 1);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_FLOWERS      , GOSSIP_SENDER_SEC_VENDORS, GOSSIP_ACTION_INFO_DEF + 2);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_FRUIT        , GOSSIP_SENDER_SEC_VENDORS, GOSSIP_ACTION_INFO_DEF + 3);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_GENERAL      , GOSSIP_SENDER_SEC_VENDORS, GOSSIP_ACTION_INFO_DEF + 4);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_JEWERLY      , GOSSIP_SENDER_SEC_VENDORS, GOSSIP_ACTION_INFO_DEF + 5);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_PET          , GOSSIP_SENDER_SEC_VENDORS, GOSSIP_ACTION_INFO_DEF + 6);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_PIE          , GOSSIP_SENDER_SEC_VENDORS, GOSSIP_ACTION_INFO_DEF + 7);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_REAGENZ      , GOSSIP_SENDER_SEC_VENDORS, GOSSIP_ACTION_INFO_DEF + 8);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_TOYS         , GOSSIP_SENDER_SEC_VENDORS, GOSSIP_ACTION_INFO_DEF + 9);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_TRINKETS     , GOSSIP_SENDER_SEC_VENDORS, GOSSIP_ACTION_INFO_DEF + 10);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_WEAPONS      , GOSSIP_SENDER_SEC_VENDORS, GOSSIP_ACTION_INFO_DEF + 11);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_WHINE		, GOSSIP_SENDER_SEC_VENDORS, GOSSIP_ACTION_INFO_DEF + 12);
			pPlayer->SEND_GOSSIP_MENU(14117, pCreature->GetGUID());
            break;
			case GOSSIP_ACTION_INFO_DEF + 13:                   //Points of Interest
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HORDE		, GOSSIP_SENDER_SEC_AUCTIONHOUSE, GOSSIP_ACTION_INFO_DEF + 1);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALLIANCE     , GOSSIP_SENDER_SEC_AUCTIONHOUSE, GOSSIP_ACTION_INFO_DEF + 2);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_VCITADEL     , GOSSIP_SENDER_SEC_POI, GOSSIP_ACTION_INFO_DEF + 3);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_VHOLD		, GOSSIP_SENDER_SEC_POI, GOSSIP_ACTION_INFO_DEF + 4);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_DISTRICT		, GOSSIP_SENDER_SEC_POI, GOSSIP_ACTION_INFO_DEF + 5);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_KARASUS		, GOSSIP_SENDER_SEC_POI, GOSSIP_ACTION_INFO_DEF + 6);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_MEMORIAL		, GOSSIP_SENDER_SEC_POI, GOSSIP_ACTION_INFO_DEF + 7);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_SQUARE		, GOSSIP_SENDER_SEC_POI, GOSSIP_ACTION_INFO_DEF + 8);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_EVENTIDE		, GOSSIP_SENDER_SEC_POI, GOSSIP_ACTION_INFO_DEF + 9);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_CEMETERY		, GOSSIP_SENDER_SEC_POI, GOSSIP_ACTION_INFO_DEF + 10);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_LEXICON		, GOSSIP_SENDER_SEC_POI, GOSSIP_ACTION_INFO_DEF + 11);
			pPlayer->SEND_GOSSIP_MENU(13975, pCreature->GetGUID());
            break;
			case GOSSIP_ACTION_INFO_DEF + 14:                   //Trainers
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_CLASSTRAINER , GOSSIP_SENDER_SEC_TRAINERS, GOSSIP_ACTION_INFO_DEF + 1);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_COLDFLY      , GOSSIP_SENDER_SEC_TRAINERS, GOSSIP_ACTION_INFO_DEF + 2);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_PORTAL       , GOSSIP_SENDER_SEC_TRAINERS, GOSSIP_ACTION_INFO_DEF + 3);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_PROFTRAINER  , GOSSIP_SENDER_SEC_TRAINERS, GOSSIP_ACTION_INFO_DEF + 4);
			pPlayer->SEND_GOSSIP_MENU(14000, pCreature->GetGUID());
            break;
	}
}

void SendArenaMenu_guard_dalaran(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    switch (uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF + 1:                    //Eastern Sewer Entrance
            pPlayer->SEND_POI(5802, 552.28, 7, 99, 0, "Dalaran Eastern Sewer Entrance");
            pPlayer->SEND_GOSSIP_MENU(13961, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 2:                    //Western Sewer Entrance
            pPlayer->SEND_POI(5816, 760.085, 7, 99, 0, "Dalaran Western Sewer Entrance");
            pPlayer->SEND_GOSSIP_MENU(13960, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 3:                    //Well Entrance
            pPlayer->SEND_POI(5879, 652.782, 7, 99, 0, "Dalaran Well");
            pPlayer->SEND_GOSSIP_MENU(13969, pCreature->GetGUID());
            break;
    }
}

void SendAuctionhouseMenu_guard_dalaran(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    switch (uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF + 1:                    //The Horde Quarter
            pPlayer->SEND_POI(5857, 595.421, 7, 99, 0, "The Horde Quarter");
            pPlayer->SEND_GOSSIP_MENU(13972, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 2:                    //The Alliance Quarter
            pPlayer->SEND_POI(5758, 715.641, 7, 99, 0, "The Alliance Quarter");
            pPlayer->SEND_GOSSIP_MENU(13973, pCreature->GetGUID());
            break;
    }
}

void SendBankMenu_guard_dalaran(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    switch (uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF + 1:                    //Northern Bank
            pPlayer->SEND_POI(5966, 613.917, 7, 99, 0, "Dalaran Northern Bank");
            pPlayer->SEND_GOSSIP_MENU(14005, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 2:                    //Southern Bank
            pPlayer->SEND_POI(5640, 687.532, 7, 99, 0, "Dalaran Southern Bank");
            pPlayer->SEND_GOSSIP_MENU(14006, pCreature->GetGUID());
            break;
    }
}

void SendInnMenu_guard_dalaran(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    switch (uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF + 1:                    //Horde Inn
            pPlayer->SEND_POI(5885, 521.776, 7, 99, 0, "Dalaran Horde Inn");
            pPlayer->SEND_GOSSIP_MENU(13993, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 2:                    //Alliance Inn
            pPlayer->SEND_POI(5731, 678.199, 7, 99, 0, "Dalaran Alliance Inn");
            pPlayer->SEND_GOSSIP_MENU(13992, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 3:                    //Neutral Inn
            pPlayer->SEND_POI(5848, 636.675, 7, 99, 0, "Dalaran Inn");            
            break;
    }
}

void SendMailboxMenu_guard_dalaran(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    switch (uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF + 1:                    //Inn
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HORDEINN     , GOSSIP_SENDER_SEC_INN, GOSSIP_ACTION_INFO_DEF + 1);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALLIANCEINN  , GOSSIP_SENDER_SEC_INN, GOSSIP_ACTION_INFO_DEF + 2);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_DALARANINN   , GOSSIP_SENDER_SEC_INN, GOSSIP_ACTION_INFO_DEF + 3);
			pPlayer->SEND_GOSSIP_MENU(14002, pCreature->GetGUID());
		...
		case GOSSIP_ACTION_INFO_DEF + 2:                    //Bank
			...
			pPlayer->SEND_GOSSIP_MENU(14007, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 3:                    //Krasus' Landing
            pPlayer->SEND_POI(5831, 508.617, 7, 99, 0, "Dalaran Krasus' Landing");
            pPlayer->SEND_GOSSIP_MENU(14009, pCreature->GetGUID());
            break;
    }
}

void SendVendorssecMenu_guard_dalaran(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    switch (uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF + 1:                    //Armor
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_CLOTH        , GOSSIP_SENDER_THI_VENDORS, GOSSIP_ACTION_INFO_DEF + 1);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_LEATHER      , GOSSIP_SENDER_THI_VENDORS, GOSSIP_ACTION_INFO_DEF + 2);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_MAIL         , GOSSIP_SENDER_THI_VENDORS, GOSSIP_ACTION_INFO_DEF + 3);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_PLATE        , GOSSIP_SENDER_THI_VENDORS, GOSSIP_ACTION_INFO_DEF + 4);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_SHIELDS      , GOSSIP_SENDER_THI_VENDORS, GOSSIP_ACTION_INFO_DEF + 5);
			pPlayer->SEND_GOSSIP_MENU(14114, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 2:                    //Flowers
            pPlayer->SEND_POI(5773, 576.271, 7, 99, 0, "Dalaran Flowers");
            pPlayer->SEND_GOSSIP_MENU(14107, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 3:                    //Fruit
            pPlayer->SEND_POI(5750, 695.409, 7, 99, 0, "Dalaran Fruit Vendor");
            pPlayer->SEND_GOSSIP_MENU(14106, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 4:                    //General & Trade Store
            pPlayer->SEND_POI(5684, 617.319, 7, 99, 0, "Dalaran General & Trade Store");
            pPlayer->SEND_GOSSIP_MENU(14105, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 5:                    //Jewel
            pPlayer->SEND_POI(5873, 721.729, 7, 99, 0, "Dalaran Jewelcrafting");
            pPlayer->SEND_GOSSIP_MENU(13984, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 6:                    //Pet
            pPlayer->SEND_POI(5847, 567.15, 7, 99, 0, "Dalaran Pet Store");
            pPlayer->SEND_GOSSIP_MENU(14001, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 7:                    //Pie, Pastry & Cake
            pPlayer->SEND_POI(5906, 628.194, 7, 99, 0, "Dalaran Pie, Pastry & Cake");
            pPlayer->SEND_GOSSIP_MENU(14102, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 8:                    //Reagents
            pPlayer->SEND_POI(5765, 734.329, 7, 99, 0, "Dalaran Reagents");
            pPlayer->SEND_GOSSIP_MENU(14104, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 9:                    //Toys
            pPlayer->SEND_POI(5814, 690.78, 7, 99, 0, "Dalaran Toy Store");
            pPlayer->SEND_GOSSIP_MENU(14100, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 10:                    //Trinkets
            pPlayer->SEND_POI(5752, 645.427, 7, 99, 0, "Dalaran Trinkets");
            pPlayer->SEND_GOSSIP_MENU(14101, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 11:                    //Weapons
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_MELEE        , GOSSIP_SENDER_THI_VENDORS, GOSSIP_ACTION_INFO_DEF + 6);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_RANGED       , GOSSIP_SENDER_THI_VENDORS, GOSSIP_ACTION_INFO_DEF + 7);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_STAVES       , GOSSIP_SENDER_THI_VENDORS, GOSSIP_ACTION_INFO_DEF + 8);
			pPlayer->SEND_GOSSIP_MENU(14113, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 12:                    //Wine & Cheese
            pPlayer->SEND_POI(5884, 608.281, 7, 99, 0, "Dalaran Wine & Cheese");
            pPlayer->SEND_GOSSIP_MENU(14095, pCreature->GetGUID());
            break;
    }
}

void SendVendorsthiMenu_guard_dalaran(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    switch (uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF + 1:                    //Cloth
            pPlayer->SEND_POI(5790, 689.124, 7, 99, 0, "Dalaran Cloth Armor & Clothing");
            pPlayer->SEND_GOSSIP_MENU(14112, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 2:                    //Leather
            pPlayer->SEND_POI(5671.76, 629.458, 7, 99, 0, "Dalaran Leather & Mail Armor");
            pPlayer->SEND_GOSSIP_MENU(14111, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 3:                    //Mail
            pPlayer->SEND_POI(5671.76, 629.458, 7, 99, 0, "Dalaran Leather & Mail Armor");
            pPlayer->SEND_GOSSIP_MENU(14111, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 4:                    //Plate
            pPlayer->SEND_POI(5912.78, 665.419, 7, 99, 0, "Dalaran Plate Armor & Shields");
            pPlayer->SEND_GOSSIP_MENU(14109, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 5:                    //Shield
            pPlayer->SEND_POI(5912.78, 665.419, 7, 99, 0, "Dalaran Plate Armor & Shields");
            pPlayer->SEND_GOSSIP_MENU(14109, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 6:                    //Melee Weapons
            pPlayer->SEND_POI(5727, 603.694, 7, 99, 0, "Dalaran Melee Weapons");
            pPlayer->SEND_GOSSIP_MENU(14098, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 7:                    //Ranged Weapons
            pPlayer->SEND_POI(5780, 558.349, 7, 99, 0, "Dalaran Ranged Weapons");
            pPlayer->SEND_GOSSIP_MENU(14097, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 8:                    //Staves & Wands
            pPlayer->SEND_POI(5667, 645.391, 7, 99, 0, "Dalaran Staves & Wands");
            pPlayer->SEND_GOSSIP_MENU(14096, pCreature->GetGUID());
            break;
    }
}

void SendPointofiMenu_guard_dalaran(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    switch (uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF + 3:                    //Violet Citadel
            pPlayer->SEND_POI(5797, 794.906, 7, 99, 0, "Dalaran Violet Citadel");
            pPlayer->SEND_GOSSIP_MENU(13971, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 4:                    //Violet Hold
            pPlayer->SEND_POI(5691, 500.56, 7, 99, 0, "Dalaran Violet Hold");
            pPlayer->SEND_GOSSIP_MENU(13970, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 5:                    //Trade District
            pPlayer->SEND_POI(5899, 728.851, 7, 99, 0, "Dalaran Trade District");
            pPlayer->SEND_GOSSIP_MENU(13980, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 6:                    //Krasus' Landing
            pPlayer->SEND_POI(5831, 508.617, 7, 99, 0, "Dalaran Krasus' Landing");
            pPlayer->SEND_GOSSIP_MENU(14009, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 7:                    //Antonidas Memorial
            pPlayer->SEND_POI(5952, 674.611, 7, 99, 0, "Dalaran Antonidas Memorial");
            pPlayer->SEND_GOSSIP_MENU(13968, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 8:                    //Runeweaver Square
            pPlayer->SEND_POI(5804, 639.554, 7, 99, 0, "Dalaran Runeweaver Square");
            pPlayer->SEND_GOSSIP_MENU(13967, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 9:                    //Eventide
            pPlayer->SEND_POI(5710, 645.397, 7, 99, 0, "Dalaran Eventide");
            pPlayer->SEND_GOSSIP_MENU(13966, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 10:                    //Cemetary
            pPlayer->SEND_POI(5851, 766.287, 7, 99, 0, "Dalaran Cemetary");
            pPlayer->SEND_GOSSIP_MENU(13965, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 11:                    //Power of lexion
            pPlayer->SEND_POI(5860, 702.517, 7, 99, 0, "Dalaran Power of Lexion");
            pPlayer->SEND_GOSSIP_MENU(14174, pCreature->GetGUID());
            break;
    }
}

void SendTrainersMenu_guard_dalaran(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    switch (uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF + 1:                    //Battlemaster
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HORDE		, GOSSIP_SENDER_SEC_AUCTIONHOUSE, GOSSIP_ACTION_INFO_DEF + 1);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALLIANCE     , GOSSIP_SENDER_SEC_AUCTIONHOUSE, GOSSIP_ACTION_INFO_DEF + 2);
            pPlayer->SEND_GOSSIP_MENU(14018, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 2:                    //Cold Weather Flying Trainer
            pPlayer->SEND_POI(5831, 508.617, 7, 99, 0, "Dalaran Krasus' Landing");
            pPlayer->SEND_GOSSIP_MENU(13998, pCreature->GetGUID());
            break;
		case GOSSIP_ACTION_INFO_DEF + 3:                    //Portal Trainer
            pPlayer->SEND_POI(5808, 581.308, 7, 99, 0, "Dalaran Mage Trainer");
            pPlayer->SEND_GOSSIP_MENU(13999, pCreature->GetGUID());
            break;
       case GOSSIP_ACTION_INFO_DEF + 4:                    //Proftrainer
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALCHEMY      , GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 1);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_BLACKSMITHING, GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 2);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_COOKING      , GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 3);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ENCHANTING   , GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 4);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ENGINEERING  , GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 5);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_FIRSTAID     , GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 6);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_FISHING      , GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 7);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HERBALISM    , GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 8);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_INSCRIPTION  , GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 9);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_JEWELCRAFTING, GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 10);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_LEATHERWORKING, GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 11);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_MINING		, GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 12);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_SKINNING     , GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 13);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_TAILORING    , GOSSIP_SENDER_THI_TRAINERS, GOSSIP_ACTION_INFO_DEF + 14);
			pPlayer->SEND_GOSSIP_MENU(7518, pCreature->GetGUID());
            break;
    }
}

void SendTrainersThiMenu_guard_dalaran(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    switch (uiAction)
    {
        case GOSSIP_ACTION_INFO_DEF + 1:                    //Alchemy
			pPlayer->SEND_POI(5890, 704.071, 7, 99, 0, "Dalaran Alchemy Trainer");
            pPlayer->SEND_GOSSIP_MENU(13995, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 2:                    //Blacksmithing
			pPlayer->SEND_POI(5904, 680.889, 7, 99, 0, "Dalaran Blacksmithing Trainer");
        ...
        case GOSSIP_ACTION_INFO_DEF + 3:                    //Cooking
            ...
            break;
        case GOSSIP_ACTION_INFO_DEF + 4:                    //Enchanting
			pPlayer->SEND_POI(5837, 722.8, 7, 99, 0, "Dalaran Enchanting Trainer");
            pPlayer->SEND_GOSSIP_MENU(13990, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 5:                    //Engineering
			pPlayer->SEND_POI(5920, 728.168, 7, 99, 0, "Dalaran Engineering Trainer");
            pPlayer->SEND_GOSSIP_MENU(13989, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 6:                    //First Aid
			pPlayer->SEND_POI(5862, 743.351, 7, 99, 0, "Dalaran First Aid Trainer");
            pPlayer->SEND_GOSSIP_MENU(13988, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 7:                    //Fishing
			pPlayer->SEND_POI(5704, 613.969, 7, 99, 0, "Dalaran Fishing Fountain");
            pPlayer->SEND_GOSSIP_MENU(13987, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 8:                    //Herbalism
			pPlayer->SEND_POI(5875, 691.28, 7, 99, 0, "Dalaran Herbalism Trainer");
            pPlayer->SEND_GOSSIP_MENU(13986, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 9:                    //Inscription
			pPlayer->SEND_POI(5860, 702.517, 7, 99, 0, "Dalaran Inscription Trainer");
            pPlayer->SEND_GOSSIP_MENU(13985, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 10:                    //Jewelcrafting
			pPlayer->SEND_POI(5873, 721.729, 7, 99, 0, "Dalaran Jewelcrafting Trainer");
            pPlayer->SEND_GOSSIP_MENU(13984, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 11:                    //Leatherworking
			pPlayer->SEND_POI(5903, 750.206, 7, 99, 0, "Dalaran Leatherworking Trainer");
            pPlayer->SEND_GOSSIP_MENU(13982, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 12:                    //Mining
			pPlayer->SEND_POI(5919, 709.664, 7, 99, 0, "Dalaran Mining Trainer");
            pPlayer->SEND_GOSSIP_MENU(13983, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 13:                    //Skinning
			pPlayer->SEND_POI(5903, 750.314, 7, 99, 0, "Dalaran Skinning Trainer");
            pPlayer->SEND_GOSSIP_MENU(13982, pCreature->GetGUID());
            break;
        case GOSSIP_ACTION_INFO_DEF + 14:                    //Tailoring
			pPlayer->SEND_POI(5882, 745.847, 7, 99, 0, "Dalaran Tailoring Trainer");
            pPlayer->SEND_GOSSIP_MENU(13981, pCreature->GetGUID());
            break;
    }
}

bool GossipSelect_guard_dalaran(Player* pPlayer, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
    switch (uiSender)
    {
        case GOSSIP_SENDER_MAIN:            SendDefaultMenu_guard_dalaran(pPlayer, pCreature, uiAction); break;
		case GOSSIP_SENDER_SEC_ARENA:       SendArenaMenu_guard_dalaran(pPlayer, pCreature, uiAction); break;
		case GOSSIP_SENDER_SEC_AUCTIONHOUSE:SendAuctionhouseMenu_guard_dalaran(pPlayer, pCreature, uiAction); break;
		case GOSSIP_SENDER_SEC_BANK:		SendBankMenu_guard_dalaran(pPlayer, pCreature, uiAction); break;
		case GOSSIP_SENDER_SEC_INN:			SendInnMenu_guard_dalaran(pPlayer, pCreature, uiAction); break;
		case GOSSIP_SENDER_SEC_MAILBOX:		SendMailboxMenu_guard_dalaran(pPlayer, pCreature, uiAction); break;
		case GOSSIP_SENDER_SEC_VENDORS:     SendVendorssecMenu_guard_dalaran(pPlayer, pCreature, uiAction); break;
		case GOSSIP_SENDER_THI_VENDORS:		SendVendorsthiMenu_guard_dalaran(pPlayer, pCreature, uiAction); break;
		case GOSSIP_SENDER_SEC_POI:			SendPointofiMenu_guard_dalaran(pPlayer, pCreature, uiAction); break;
		case GOSSIP_SENDER_SEC_TRAINERS:	SendTrainersMenu_guard_dalaran(pPlayer, pCreature, uiAction); break;
		case GOSSIP_SENDER_THI_TRAINERS:	SendTrainersThiMenu_guard_dalaran(pPlayer, pCreature, uiAction); break;
	}
    return true;
}
...
void AddSC_guards()
{
    ...
    newscript->GetAI = &GetAI_guard_dalaran;
    newscript->RegisterSelf();
