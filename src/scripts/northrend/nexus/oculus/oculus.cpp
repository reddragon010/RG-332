...
bool GOHello_go_orb_of_the_nexus(Player *pPlayer, GameObject *pGO)
{
...
bool GOHello_go_nexus_portal(Player *pPlayer, GameObject *pGO)
{
...
void AddSC_oculus()
{
    ...
    newscript = new Script;
    newscript->Name = "go_orb_of_the_nexus";
    newscript->pGOHello = &GOHello_go_orb_of_the_nexus;
    newscript->RegisterSelf();

    newscript = new Script;
    newscript->Name = "go_nexus_portal";
    newscript->pGOHello = &GOHello_go_nexus_portal;
    newscript->RegisterSelf();
}
