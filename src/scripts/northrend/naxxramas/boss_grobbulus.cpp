...
#define SPELL_POISON_CLOUD_ADD      38462  // not correct spell, correct spells: 28158, 54362 have no visuals
...
struct boss_grobbulusAI : public BossAI
{
    ...
    {
        _Reset();
        uiSlimeStreamTimer = 3*IN_MILISECONDS;
    }
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        else uiSlimeStreamTimer = 3*IN_MILISECONDS;
