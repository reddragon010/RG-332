...
(0, "Null check",         0, 3, 0, 11000, 0, 0,    0, 0, 1, 0, 0, 0),
(1, "Movement cheat",     0, 3, 0, 11000, 0, 0,    0, 0, 2, 1, 0, 0),
(2, "Spell cheat",        0, 3, 0, 11000, 0, 0,    0, 0, 2, 1, 0, 0),
(3, "Quest cheat",        0, 3, 0, 11000, 0, 0,    0, 0, 2, 1, 0, 0),
(4, "Transport cheat",    0, 3, 0, 11000, 0, 0, 60.0, 0, 2, 1, 0, 0),
(5, "Damage cheat",       0, 3, 0, 11000, 0, 0,    0, 0, 2, 1, 0, 0),
...
--
(201, "Spell invalid",             0, 3, 0, 11000,        0, 0,      0,    0, 2, 1, 0, 0),
(202, "Spellcast in dead state",   0, 3, 0, 11000,        0, 0,      0,    0, 2, 1, 0, 0),
(203, "Spell not valid for player",0, 3, 0, 11000,        0, 0,      0,    0, 2, 1, 0, 0),
(204, "Spell not in player book",  0, 3, 0, 11000,        0, 0,      0,    0, 2, 1, 0, 0),
--
(501, "Spell damage hack",         0, 3, 0, 11000,        0, 50000,  0,    0, 2, 1, 0, 0),
(502, "Melee damage hack",         0, 3, 0, 11000,        0, 50000,  0,    0, 2, 1, 0, 0),
